<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
                <img src="{{ dashboarder_asset('/statics/img/logo-white.svg') }}" width="110" height="32" alt="Tabler"
        ...
        <div class="navbar-nav flex-row d-lg-none">
            ...
            @include('dashboarder::sections.topbar_notifications')
            @include('dashboarder::sections.user_avatar')
        </div>
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                <p class="menu-title-separator mx-3">Application</p>
                @foreach (config('dashboarder.dashboard.menus') as $menu)
                    <li class="nav-item">
                        <a class="nav-link" @if ($menu['target_blank']) target="_blank" @endif href="./index.html">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                {{ dashboarder_icon($menu['icon']) }}
                            </span>
